...
const warehouse = new WarehouseModel();
	...
	warehouse.rackL = 40; // rack length (cells)
	warehouse.blockAmnt = 6; // number of blocks (sections of racks)
	warehouse.rackAmntPerBlock = 6; // racks per block
